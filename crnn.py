...
class CNN_BiGRU_Classifier(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layers, output_size, n_windows, dropout_rate=0.2):
    ...
    def forward(self, x):
        ...
        # Output layer
        #x = x[:, -self.n_windows:, :]  # Shape: (batch_size, 20, hidden_size * 2)
...
if __name__ == "__main__":     
    ...
    model = CNN_BiGRU_Classifier(input_size, hidden_size, num_layers, output_size, 20, dropout_rate)
    # Define the input tensor
    sequence_length = 10000 # Chop up window is going to be the same length
